...
public interface CartSerive {
	...
	public CartItem addItemToCart(AddCartItemRequest req, Long id) throws UserException, FoodException, CartException, CartItemException;

	public CartItem updateCartItemQuantity(Long cartItemId,int quantity) throws CartItemException;

	public Cart removeItemFromCart(Long cartItemId, Long id) throws UserException, CartException, CartItemException;
